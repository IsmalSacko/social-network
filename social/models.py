...
class ThreadModel(models.Model):
    ...
    receiver = models.ForeignKey(User, on_delete=models.CASCADE, related_name='+', blank=True, null=True)


class MessageModel(models.Model):
    thread = models.ForeignKey('ThreadModel', related_name='+', on_delete=models.CASCADE, blank=True, null=True)
    sender_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='+', blank=True, null=True)
    receiver_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='+', blank=True, null=True)
